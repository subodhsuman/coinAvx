...
<div>
    <!-- Modal -->
    <div class="deposite_modal modal fade" id="DepositModal" tabindex="-1" aria-labelledby="DepositModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header p-4 text-center border-0">
                    <h5 class="modal-title" id="exampleModalLabel"> Deposite BTC</h5>
                        ...
                        <div class="row py-1 justify-content-center">
                            ...
                            <div class="col-xl-8 mb-4">
                                ...
                                <div class="input-group mb-1">
                                    <input class="form-control shadow-none border-end-0 py-2" type="text" placeholder="TBxTg48Y9ZRajLQpe9WDY9jYBWTANWSpps">
                                    <span class="input-group-text border-start-0" style="cursor: pointer;">
                                        <img src="../../assets/images/icons/copy.svg" alt="icon"> &nbsp; Copy</span>
                                </div>

                            </div>
                            <div class="col-xl-12 mb-3">
                                <div class="scan_img text-center">
                                    <img src="../../assets/images/scanner.png" alt="image">
                                </div>
                            </div>
                            <div class="col-xl-12 mb-3">
                                <div class="mimimum_box">
                                    <p class="mb-0">Minimum Deposit : <span> 0 BTC</span></p>
...
.deposite_modal ::placeholder{
    color: var(--avx-white);
}
/* EDIT MPODAL */
.deposite_modal .modal-content {
    background-color: var(--setting-choco);
...
.deposite_modal .form-control,
.deposite_modal .input-group-text {
    font-size: 14px;
    color: var(--avx-white);
