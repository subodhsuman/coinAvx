            ...
            <div class="setting_slot_box">
                ...
                <div class="setting_inner_content row  justify-content-between p-md-5 p-2">
                    ...
                    <div class="col-md-12 col-lg-12 col-xl-12 setting_sub_heading">
                        <!-- sub haeding -->
                        <SubHeading sub_heading="Deposit history"></SubHeading>
                    </div>
...
export default {
    ...
    data() {
        return {
            ...
            perPageData: 1,
            loading: true,
            Deposit_HistoryData:PortfolioData.Deposit_HistoryData,
