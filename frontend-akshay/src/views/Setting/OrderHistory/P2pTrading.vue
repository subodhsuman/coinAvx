            ...
            <div class="setting_slot_box">
                ...
                <div class="setting_inner_content row  justify-content-between p-md-5 p-2">
                    ...
                    <div class="col-md-12 col-lg-12 col-xl-12">
                        <div class="p2p-trading-table table-responsive">
...
.p2p-trading-table thead tr th:first-child {
    border-top-left-radius: 20px;
    border-bottom-left-radius: 20px;
}

.p2p-trading-table thead tr th:last-child {
    border-top-right-radius: 20px;
    border-bottom-right-radius: 20px;
}

.p2p-trading-table thead tr th {
    font-weight: 500;
    font-size: 14px;
}

.p2p-trading-table tbody tr td {
    font-weight: 500;
    font-size: 14px;
}

.p2p-trading-table .form-check-input:checked {
    background-color: var(--avx-yellow);
    border-color: var(--avx-yellow);
}

.p2p-trading-table .form-check-input {
